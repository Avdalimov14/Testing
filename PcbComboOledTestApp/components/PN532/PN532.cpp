...
uint8_t PN532::mifareclassic_WriteNDEFURI (uint8_t sectorNumber, uint8_t uriIdentifier, const char *url)
{
    ...
    uint8_t lenPlus5 = len + 5;
    uint8_t lenPlus1 = len + 1;
    uint8_t sectorbuffer1[16] = {0x00, 0x00, 0x03, lenPlus5, 0xD1, 0x01, lenPlus1, 0x55, uriIdentifier, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
*/
/**************************************************************************/
bool PN532::inListPassiveTarget(bool noResponse)
{
    pn532_packetbuffer[0] = PN532_COMMAND_INLISTPASSIVETARGET;
