...
#define LEDC_HS_CH0_RRGB2       (32)
#define LEDC_HS_CH0_CHANNEL   	LEDC_CHANNEL_0
#define LEDC_HS_CH1_GRGB2       (21)
#define LEDC_HS_CH1_CHANNEL		LEDC_CHANNEL_1
#define LEDC_HS_CH2_BRGB2 		(22)
...
int app_main(void) {
	...
	while (1) {
		...
		printf("Please press on GPIO 0 to continue test... (Fade in then out order--> red,green,blue,all-together)\n");
		waitUntilPress(GPIO_INPUT_IO0);
		// RGB IOs 32,21,22 greed led IO35 connected to IO12...
